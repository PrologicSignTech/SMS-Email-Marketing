...
namespace MarketingPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260208195343_AddPhoneNumbersAndSuppressionRules")]
    partial class AddPhoneNumbersAndSuppressionRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.FooterSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.LandingFaq", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.LandingFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StatTitle1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatTitle2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatTitle3")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.LandingStat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.PageContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.SecurityBadge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<string>("PayPalPlanIdMonthly")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PayPalPlanIdYearly")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.Testimonial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.TrustedCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.UseCase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.ChatRoom", b =>
                {
                    b.HasOne("MarketingPlatform.Core.Entities.ApplicationUser", "AssignedEmployee")
                        .WithMany("AssignedChatRooms")
                        .HasForeignKey("AssignedEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MarketingPlatform.Core.Entities.ApplicationUser", "Customer")
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("AssignedChatRooms");
            ...
            modelBuilder.Entity("MarketingPlatform.Core.Entities.Feature", b =>
                {
                    b.Navigation("PlanFeatureMappings");
                });
