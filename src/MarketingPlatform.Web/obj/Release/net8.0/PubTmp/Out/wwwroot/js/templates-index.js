...
function previewTemplate(id) { window.location.href = (typeof AppUrls !== 'undefined' && AppUrls?.templates?.preview) ? AppUrls.templates.preview(id) : `/Templates/Edit/${id}`; }
function editTemplate(id) { window.location.href = (typeof AppUrls !== 'undefined' && AppUrls?.templates?.edit) ? AppUrls.templates.edit(id) : `/Templates/Edit/${id}`; }
