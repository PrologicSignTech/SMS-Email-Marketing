...
function getAuthToken() {
    // Priority: server-injected token (from cookie claims) > localStorage > sessionStorage
    return window.authConfig?.token || localStorage.getItem('authToken') || sessionStorage.getItem('authToken');
}
